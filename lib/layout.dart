...
class Layout {
  ...
  static Color primary([double opacity = 1]) => Color(0xff800080).withOpacity(opacity);
  static Color primaryDark([double opacity = 1]) => Color(0xff7a297a).withOpacity(opacity);
  static Color primaryLight([double opacity = 1]) => Color(0xffbf40bf).withOpacity(opacity);

  static Color secondary([double opacity = 1]) => Color(0xff800080).withOpacity(opacity);
  static Color secondaryDark([double opacity = 1]) => Color(0xff800080).withOpacity(opacity);
  static Color secondaryLight([double opacity = 1]) => Color(0xffbf40bf).withOpacity(opacity);
  ...
  static Color info([double opacity = 1]) => Color(0xffb8860b).withOpacity(opacity);
